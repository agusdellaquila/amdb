                ...
                <div className="details-movies-container">
                    <div className="info-container-background">
                        <div className="info-container">
                            ...
                            {details.tagline ? <p className="info-tagline font-semibold"> "{details.tagline}" </p> : <div className="hidden"></div>}
                            ...
                            <div className="flex justify-between">
                                { details.budget === 0 ? <p className="info-subheading"> BUDGET: <span>Not available</span></p> : <p className="info-subheading"> BUDGET: <span>{details.budget}</span></p> }
                                { details.revenue === 0 ? <p className="info-subheading"> REVENUE: <span>Not available</span></p> : <p className="info-subheading"> REVENUE: <span>{details.revenue}</span></p> }
                            </div>
